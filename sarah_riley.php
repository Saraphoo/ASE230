...
<html lang="en"> 
<head>
    <title><?= 'Sarah Riley'?>'s Resume</title>
    
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="<?= 'Sarah Riley'?>'s resume">
...
<body>
				    ...
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase"><?= 'Sarah Riley'?></h1>
							    <div class="title mb-3"><?='Software Engineer'?></div>
							    <ul class="list-unstyled">
								    <li class="mb-2"><a class="text-link" href="#"><i class="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i><?='Rileys14@mymail.nku.edu'?></a></li>
								    <li><a class="text-link" href="#"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i><?='(989) 387-3686'?></a></li>
							    </ul>
						    </div><!--//primary-info-->
						    <div class="secondary-info col-auto mt-2">
							    <ul class="resume-social list-unstyled">
					                <li class="mb-3"><a class="text-link" href="<?='https://www.linkedin.com/in/sarah-riley-33a429241/'?>"><span class="fa-container text-center me-2"><i class="fab fa-linkedin-in fa-fw"></i></span><?='linkedin.com/in/sarah-riley-33a429241'?></a></li>
					                <li class="mb-3"><a class="text-link" href="<?='https://github.com/Saraphoo'?>"><span class="fa-container text-center me-2"><i class="fab fa-github-alt fa-fw"></i></span><?='github.com/Saraphoo'?></a></li>
					                <li><a class="text-link" href="#"><span class="fa-container text-center me-2"><i class="fas fa-globe"></i></span><?= 'Sarahriley'?>.com</a></li>
							    </ul>
						    </div><!--//secondary-info-->
					    </div><!--//row-->
    ...
    <footer class="footer text-center pt-2 pb-5">
        ...
        <small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart"></i> by <?= 'Sarah Riley'?></small>
    </footer>
